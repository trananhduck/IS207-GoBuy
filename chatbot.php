...
<style>
    ...
    .chatbot-header span {
        flex-grow: 1;
        /* Cho phép tiêu đề chiếm không gian còn lại, đẩy các nút về phía phải */
        margin-right: auto;
        /* Đảm bảo tiêu đề đẩy các nút ra xa nhất có thể */
    }
            ...
            fetch('clear_chat_history.php', { // Đảm bảo bạn tạo file PHP này
                ...
                .then(data => {
                    ...
                    if (data.status === 'error') {
                        appendMessage('Đã xảy ra lỗi khi xóa lịch sử trò chuyện trên máy chủ: ' + data.message,
                            'bot');
                    }
                })
                .catch(error => {
                    ...
                    appendMessage(
                        'Không thể kết nối với máy chủ để xóa lịch sử. Vui lòng kiểm tra kết nối mạng.',
                        'bot');
                });
        }
        ...
        function sendMessage() {
            ...
            sendToBackend(message)
                ...
                .catch(error => {
                    ...
                    appendMessage('Không thể kết nối với máy chủ. Vui lòng kiểm tra kết nối mạng của bạn.',
                        'bot');
                });
        }
