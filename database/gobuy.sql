...
(1, 'Làm sao để mua hàng trên GoBuy?', '<h3 class=\"checkout-complete-box font-bold txt16\" style=\"box-sizing: inherit; text-rendering: optimizeLegibility; margin: 0.2rem 0px 0.5rem; padding: 0px; line-height: 1.4; background-color: rgb(250, 250, 250);\"><span style=\"font-size: 15.7143px; color: rgb(34, 34, 34); font-family: opensans, \\\"Helvetica Neue\\\", Helvetica, Helvetica, Arial, sans-serif;\">Bạn chỉ cần chọn sản phẩm yêu thích, thêm vào giỏ hàng, sau đó tiến hành thanh toán theo hướng dẫn. Chúng tôi hỗ trợ nhiều phương thức thanh toán như chuyển khoản, ví điện tử và COD.</span></h3>'),
(2, 'Thời gian giao hàng là bao lâu?', '<p><span style=\"color: rgb(10, 10, 10); font-family: opensans, &quot;Helvetica Neue&quot;, Helvetica, Helvetica, Arial, sans-serif; font-size: 14px;\">Thời gian giao hàng phụ thuộc vào vị trí của bạn. Thông thường, đơn hàng sẽ được giao trong 2-5 ngày làm việc đối với khu vực nội thành và 3-7 ngày làm việc đối với khu vực ngoại thành.</span></p>'),
(3, 'Tôi có thể đổi sản phẩm đã mua không?', '<p>Nếu bạn muốn đổi sản phẩm vì lý do cá nhân hoặc không vừa ý, bạn có thể gửi yêu cầu đổi hàng trong vòng 7 ngày kể từ ngày nhận được hàng, với điều kiện sản phẩm còn nguyên vẹn, chưa qua sử dụng và có đầy đủ phụ kiện đi kèm.</p>'),
(4, 'Làm gì nếu sản phẩm bị thiếu hoặc sai?', '<p class=\"a\" style=\"box-sizing: inherit; text-rendering: optimizeLegibility; line-height: 1.6; margin-bottom: 0.714286rem; padding: 0px; font-size: 14px; color: rgb(10, 10, 10); font-family: opensans, &quot;Helvetica Neue&quot;, Helvetica, Helvetica, Arial, sans-serif; background-color: rgb(250, 250, 250);\">Hãy liên hệ với bộ phận chăm sóc khách hàng của chúng tôi trong vòng 48 giờ sau khi nhận hàng để được hỗ trợ. Vui lòng cung cấp hình ảnh sản phẩm và mã đơn hàng để chúng tôi xử lý nhanh chóng.</p>'),
(5, 'GoBuy có hỗ trợ giao hàng toàn quốc không?', '<p>Có! GoBuy hỗ trợ giao hàng đến tất cả các tỉnh thành trên toàn quốc. Dù bạn ở bất kỳ đâu tại Việt Nam, chỉ cần đặt hàng là chúng tôi sẽ giao tận nơi.</p>');
